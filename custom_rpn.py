...
class CustomRPN(nn.Module):
    ...
    def losses(
        ...
        # added
        if abs(gt_anchor_deltas[pos_mask].sum()) > 100000000:
            print(gt_anchor_deltas[gt_anchor_deltas > 100])
            print(gt_anchor_deltas[gt_anchor_deltas < -100])
        if localization_loss / normalizer > 100:
            print(localization_loss)
            print(normalizer)
            # print(cat(pred_anchor_deltas, dim=1)[pos_mask])
            # print(gt_anchor_deltas[pos_mask])
        losses = {
