...
from custom_fastrcnn import NewFastRCNNOutputLayers
...
class CustomROIHeads(StandardROIHeads):
    ...
    def _forward_box(self, features: Dict[str, torch.Tensor], proposals: List[Instances]):
        ...
        predictions, pred_bases, pred_depth, pred_bbox3d = self.box_predictor(box_features)
        del box_features

        if self.training:
            losses = self.box_predictor.losses((predictions, pred_bases, pred_depth, pred_bbox3d), proposals)
            ...
            pred_instances, _ = self.box_predictor.inference((predictions, pred_bases, pred_depth, pred_bbox3d), proposals)
            return pred_instances
