...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="./data/tracking", mapping_path="./data/tracking/evaluate_tracking.seqmap",
                 min_overlap=0.5, max_truncation=0, min_height=25, max_occlusion=2, mail=None, cls="car"):
